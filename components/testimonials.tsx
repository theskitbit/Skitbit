...
export function Testimonials() {
  ...
  const prev = () => {
    setActiveIndex((value) => (value - 1 + testimonials.length) % testimonials.length);
  };
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          <article className="relative overflow-hidden rounded-[28px] border border-foreground/10 bg-white p-6 shadow-[0_16px_48px_rgba(0,0,0,0.05)] sm:p-8 lg:p-10">
            <div aria-hidden="true" className="pointer-events-none absolute -right-16 -top-16 h-60 w-60 rounded-full bg-background blur-3xl" />
            ...
            <div className="relative z-10">
              ...
              <footer className="mt-8 border-t border-border pt-5 lg:mt-9">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="hidden items-center gap-2 sm:flex">
                    ...
                    >
                      <svg width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
                    </button>
                    <button
                      type="button"
                      onClick={next}
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-full border border-border bg-background text-foreground transition-opacity duration-300 hover:opacity-70 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                    >
                      <svg width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                    </button>
                  </div>
                </div>
              </footer>
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 sm:hidden">
                ...
                >
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true"><path d="M19 12H5M12 5l-7 7 7 7" /></svg>
                  Previous
                </button>
                <button
                  type="button"
                ...
                >
                  Next
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                </button>
              </div>
            </div>
          </article>
