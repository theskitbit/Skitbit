      ...
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-[100] md:hidden" role="dialog" aria-modal="true" aria-label="Mobile navigation">
            ...
            <motion.aside className="relative z-[101] flex h-dvh w-[min(88vw,390px)] flex-col overflow-y-auto bg-background px-5 pb-8 pt-5 shadow-2xl" initial={{ x: '-100%' }} animate={{ x: 0 }} exit={{ x: '-100%' }} transition={{ type: 'spring', stiffness: 320, damping: 32 }}>
