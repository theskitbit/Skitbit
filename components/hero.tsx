...
export function Hero() {
  ...
  return (
    <section aria-label="Skitbit introduction" className="w-full bg-background py-0">
      <div className="relative mx-auto grid min-h-[629px] w-full max-w-[964px] grid-cols-1 border-x border-b border-border lg:grid-cols-2">
        ...
        <div className="flex items-center px-8 py-16 sm:px-12 lg:px-6 xl:px-6">
          <div className="w-full max-w-[500px]">
            <h1 className="m-0 max-w-[490px] text-[54px] font-medium leading-[0.9] tracking-[-0.065em] text-foreground sm:text-[64px] lg:text-[70px] xl:text-[72px]">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button type="button" onClick={open} className="btn-primary inline-flex h-11 cursor-pointer items-center justify-center rounded-full px-7 text-[15px] font-medium">
                Partner with Us
              </button>
              <Link href="/works" className="btn-ghost inline-flex h-11 items-center justify-center rounded-full px-7 text-[15px] font-medium">
                Our Work
              </Link>
            </div>
          </div>
